...
import {CardText,CardLink,Container,CardTitle, Row,Col,Card} from 'reactstrap';
...
const Home = () => {
  return (
    <>
     <Container>
        <Card className={`fw-bold ${styles.cardBody}`} body>
          ...
          <CardText className='text-secondary'>Additionally, you agree not to:</CardText>
          <CardText className='text-secondary'>
    ...
    <Card className="border-0" body>
      <Row>
        <Col sm={3}> <Card body className={styles.registerCard}>
          <CardTitle tag="h6">Register</CardTitle></Card></Col>
          <Col sm={3}> <Card body className={styles.complaintCard}>
          <CardTitle tag="h6">Add Complaint</CardTitle></Card></Col>
          <Col sm={3}> <Card body className={styles.contactCard}>
          <CardTitle tag="h6">Contact Us</CardTitle></Card></Col>
      </Row>
    </Card>
    </Container>
    </>
